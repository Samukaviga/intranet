        ...
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Adicionar Evento</h3>
                            <ul class="breadcrumb">
            ...
            <div class="row mt-2">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/adicionarEvento" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row p-2">
                                    ...
                                    <div class="col-12 col-sm-5 m-3">
                                        <div class="input-block local-forms">
                                            <label>Data</label>
                                            <input class="form-control" type="date" name="data" id="data" placeholder="DD-MM-YYYY">
                                        </div>
                                    </div>
